...
import com.liferay.aaa.data.NoSuchCustomerException;
import com.liferay.aaa.data.model.Customer;
import com.liferay.aaa.data.model.impl.CustomerImpl;
import com.liferay.aaa.data.model.impl.CustomerModelImpl;
...
public class CustomerPersistenceImpl extends BasePersistenceImpl<Customer>
	 ...
	 * @throws com.liferay.aaa.data.NoSuchCustomerException if a matching customer could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	 ...
	 * @throws com.liferay.aaa.data.NoSuchCustomerException if a customer with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	/**
	 * Returns the customer where uuid = &#63; and groupId = &#63; or throws a {@link com.liferay.aaa.data.NoSuchCustomerException} if it could not be found.
	 *
	 * @param uuid the uuid
	...
	@Override
	public Customer updateImpl(com.liferay.aaa.data.model.Customer customer)
		throws SystemException {
		customer = toUnwrappedModel(customer);
	...
	protected Customer toUnwrappedModel(Customer customer) {
		...
		customerImpl.setCustomerAddress(customer.getCustomerAddress());
		customerImpl.setCustomerNIC(customer.getCustomerNIC());
		customerImpl.setCustomerContact(customer.getCustomerContact());
		customerImpl.setDserviceId(customer.getDserviceId());
	...
	/**
	 * Returns the customer with the primary key or throws a {@link com.liferay.aaa.data.NoSuchCustomerException} if it could not be found.
	 *
	 * @param customerId the primary key of the customer
	 * @return the customer
	 * @throws com.liferay.aaa.data.NoSuchCustomerException if a customer with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.aaa.data.model.Customer")));
